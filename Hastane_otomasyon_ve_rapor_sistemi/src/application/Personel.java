...
public class Personel {
	...
	public Personel(int id, String ad, String soyad, String cinsiyet, LocalDate dogumTarihi, String tcNo,
	...
	public IntegerProperty yasProperty() {
		return new SimpleIntegerProperty(LocalDate.now().getYear() - dogumTarihi.get().getYear());
	}
