...
public class Randevu {
    ...
    public String getPoliklinik() { return poliklinik.get(); }
    public String getDoktor() { return doktor.get(); }
    ...
    public StringProperty poliklinikProperty() { return poliklinik; }
    public StringProperty doktorProperty() { return doktor; }
    public StringProperty tarihProperty() { return tarih; }
    public StringProperty saatProperty() { return saat; }
    ...
    public String toString() {
        return String.format("%s - %s (%s %s)", 
               poliklinik.get(), doktor.get(), tarih.get(), saat.get());
    }
}